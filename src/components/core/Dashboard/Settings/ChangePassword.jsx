  ...
  return (
    <div>
      <form onSubmit={handleSubmit(submitPasswordForm)}>
        <div className=' flex flex-col gap-y-6 rounded-md bg-richblack-800 border-[1px] border-richblack-700 p-6 my-10'>
            <h3 className=' text-lg font-semibold text-richblack-5'>Password</h3>
